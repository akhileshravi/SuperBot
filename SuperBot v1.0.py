...
pygame.display.set_caption('SuperBot v1.0')                    
...
def list_gen():
    ...
    """Generates random coordinates for pixelator()"""
...
def linelistgen():
    ...
    '''Creates a list of x-coordinates for exitter() '''
    try:
...
def exitter():
    ...
    '''Function for final exit animation'''
